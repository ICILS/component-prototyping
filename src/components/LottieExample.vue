...
export default {
  ...
  methods: {
    ...
    getFrameCount() {
      alert(`This animation has ${this.$refs.customControl.getDuration(true)} frames`)
    },
    getTimeCount() {
      alert(`This animation takes ${this.$refs.customControl.getDuration(false)} seconds`)
    },
    increaseSpeed() {
      this.speed += 0.5
...
<template>
  <div>
    <div>
      <Vue3Lottie ref="customControl" :animation-data="PongJSON" :height="200" :width="200" :speed="speed" />
      <div>
        <div>
          <button @click="play">
            Play
